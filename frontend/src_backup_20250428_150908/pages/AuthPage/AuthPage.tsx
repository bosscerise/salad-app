...
import { 
  ...
  AtSign, Lock, User, Sparkles, CheckCheck, ShieldCheck, Phone
} from 'lucide-react';
        ...
        <div className="flex flex-col justify-between h-full max-w-md px-8 py-12 mx-auto">
          <div>
            <motion.div 
              ...
              className="mb-8"
            >
              <h1 className="mb-2 text-3xl font-bold">Fresh Box</h1>
      ...
      <div className="flex items-center justify-center w-full p-4 bg-white md:w-1/2 md:p-0">
        <div className="w-full max-w-md px-6 py-8">
          ...
          <div className="mb-8 md:hidden">
            ...
            <h1 className="mb-1 text-2xl font-bold text-center text-gray-800">Fresh Box</h1>
...
const RegisterForm = ({ setIsLogin }: RegisterFormProps) => {
  ...
  const validateStep1 = () => {
    ...
    // Basic phone validation - ensure it's not empty and contains only valid characters
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await register({
        ...
        phone: formData.phone.trim()  // Add phone number to registration data
      });
