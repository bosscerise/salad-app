...
import { 
  ...
  Upload, RefreshCw, AlertCircle, Filter, MoreVertical
} from 'lucide-react';
...
export default function IngredientsManagement() {
  ...
  return (
    <div className="bg-white rounded-lg shadow">
      ...
      <div className="p-4 overflow-x-auto border-b bg-gray-50">
              ...
              {filteredIngredients.length > 0 ? (
                filteredIngredients.map((ingredient) => (
                  <tr key={ingredient.id} className="hover:bg-gray-50">
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500 md:hidden">
                            <span className="font-medium">{ingredient.category}</span> · ${ingredient.price.toFixed(2)}
                          </div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="hidden px-6 py-4 text-sm text-gray-500 sm:table-cell">${ingredient.price.toFixed(2)}</td>
      ...
      {showAddForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto bg-black/50">
          <div className="w-full max-w-2xl p-5 bg-white rounded-lg max-h-[90vh] overflow-y-auto sm:p-6">
