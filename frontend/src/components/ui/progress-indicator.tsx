                ...
                >
                    {!isExpanded && (
                        <motion.button
                            ...
                            onClick={handleBack}
                            className="flex items-center justify-center flex-1 w-16 px-4 py-3 text-sm font-semibold text-black transition-colors bg-gray-100 rounded-full hover:bg-gray-50 hover:border"
                        >
                            Back
                        </motion.button>
                    )}
